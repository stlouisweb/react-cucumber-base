# React Cucumber Base
This repo was ejected from Create-React-App to enable BDD with `jest-cucumber`.
To get started clone this repo then re-init git for your project's repo:
- `$ cd react-cucumber-base`
- `$ rm -rf .git/`
- `$ git init`
